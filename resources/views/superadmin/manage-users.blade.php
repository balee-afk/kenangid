                            ...
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td class="border px-4 py-2 flex space-x-2">
                                        <!-- Detail -->
                                        <button onclick="openModal('detailModal', {{ $user }})" class="text-blue-500">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 12h4M15 16h2M15 8h1M4 8h5l2 3m5-5h2" />
                                            </svg>
                                        </button>
                                        <!-- Edit -->
                                        <button onclick="openModal('editModal', {{ $user }})" class="text-yellow-500">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        ...
                                        <!-- Hapus -->
                                        <button onclick="openModal('deleteModal', {{ $user->id }})" class="text-red-500">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
